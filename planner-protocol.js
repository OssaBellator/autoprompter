...
(function attachPlannerProtocol(root, factory) {
  ...
  function buildPlannerPrompt(project, revision = 1) {
    ...
    const prompt = [
      ...
      "",
      "Planning rules:",
      `- Create between 1 and ${MAX_PLAN_TASKS} tasks and no more than ${MAX_PLAN_PHASES} phases. Prefer 6–12 concise tasks unless the goal genuinely requires more.`,
      ...
      "- Keep descriptions concise and return compact valid JSON to reduce transcription errors.",
