...
test("extension loads the role runner after the primary content runtime", () => {
  ...
  assert.deepEqual(manifest.content_scripts[0].js.slice(-2), ["content.js", "project-role-runner.js"]);
